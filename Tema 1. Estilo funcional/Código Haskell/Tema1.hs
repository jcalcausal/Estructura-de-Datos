...
{-
   ...
   * Ejercicios de currificación
   ...
   Parámetro simple sin paréntesis, compuesto con paréntesis.
...
primero :: (a, a) -> a -- predefinida como fst
primero (x,y) = x
...
-- sonSimétricos :: (Eq a, Eq b) => (a,a) -> (a, a) -> Bool
-- sonSimétricos (x,y) (u,v) = x==y
